...
public class PSchicht3// extends Polygon3
{
	/*public PSchicht3(TnTarget tn, LichtW lw, Boolean seite, IFarbe farbe, int rSeed, K4[] eckenR, K4[] eckenK)
	{
		super(tn, lw, seite);
	...
	public PSchicht3(TnTarget tn, LichtW lw, Boolean seite, IFarbe farbe,
	...
	private PSchicht3(PNonBlock3 main, int splitID, K4[] eckenR, K4[] eckenK)
	{
	...
	public void splittern(ArrayList<Anzeige3> dieListe)
	{
		...
		if(Vor.splThr > 0 && sizeForKam() > Vor.splThr)
		{
			...
			for(int j = 0; j < neueEckenK.length; j++)
			{
				...
				new PSchicht3(this, j, eR, eK).splittern(dieListe);
			}
		}
		else
			dieListe.add(this);
